...
async def create(
    ...
    return await CRUD.groups.create(db=SessionLocal, group=group)
...
async def delete(
    ...
    '''
    status = await CRUD.groups.delete(db=SessionLocal, id=id)
...
async def redo(
  ...
  response = Response()
    ...
    await CRUD.groups.redo(db=SessionLocal, id=id, redacted_group=redo_group)
    return schemas.API_Response(
...
async def search(
    ...
    return await CRUD.groups.search(SessionLocal, params=params, filter=filter)